...
%
\title{EKF Slam based on manualy selected pointcloud landmarks in a VR Application}
\author{Maximilian Kremmel, BSc}
\studentnumber{mr21m029}
%\author{Titel Vorname Name, Titel\and{}Titel Vorname Name, Titel}
%\studentnumber{XXXXXXXXXXXXXXX\and{}XXXXXXXXXXXXXXX}
\supervisor{Horst Orsolits, MSc}
%\supervisor[Begutachter]{Titel Vorname Name, Titel}
%\supervisor[Begutachterin]{Titel Vorname Name, Titel}
\secondsupervisor{Dr.rer.nat. Andrea Mizelli-Ojdanic, MSc }
...
\schlagworte{EKF Salm, VR, Punktwolken, Landmarken}
\outline{
This will be my Abstract.
}
\keywords{EKF Salm, VR, Pointclouds, Landmarks}
